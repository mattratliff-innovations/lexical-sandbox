...
export default function SupportingDocumentWrapper() {
  const [handleButtonClick, setHandleButtonClick] = useState(() => () => {});
  const quickActions = {
    listUrl: '/admin/supportingdocuments',
    listLabel: 'Supporting Documents',
    createUrl: '/admin/supportingdocuments/create',
    createLabel: 'Create Supporting Document',
    saveLabel: 'Save Supporting Document',
