...
export default function ClassPreferenceWrapper() {
  const [handleButtonClick, setHandleButtonClick] = useState(() => () => {});
  const quickActions = {
    listUrl: '/admin/classPreferences',
    listLabel: 'Class Preferences',
    createUrl: '/admin/classPreferences/create',
    createLabel: 'Create Class Preference',
    saveLabel: 'Save Class Preference',
