...
export default function SnippetWrapper() {
  ...
  const quickActions = {
    listUrl: '/admin/snippets',
    listLabel: 'Placeholder Snippets',
    createUrl: '/admin/snippets/create',
    createLabel: 'Create Placeholder Snippet',
    saveLabel: 'Save Placeholder Snippet',
