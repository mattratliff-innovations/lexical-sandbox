                ...
                <div id="left-panel">
                  ...
                  <div className="shortcut">
                    <div className="mt-5">
                      ...
                      <br />
                      <p>
                        For assistive technology users, the editing paragraph box reads technical names for variables, snippets, and standard
                        paragraphs, while Reading Mode reads its value(s) with editing ability.
                      </p>
                    </div>
                  </div>
                </div>
