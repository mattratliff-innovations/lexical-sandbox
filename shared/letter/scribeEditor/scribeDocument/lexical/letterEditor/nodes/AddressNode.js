...
import { ADDRESS_TYPE, contactToText, createContactFromDom, findDraftContact, serializeToHtml } from '../nodeDomSerializers/AddressNodeSerializer';
...
export class AddressNode extends ExtendedTextNode {
  ...
  static createFromEditor(draft, editorisOpen, options, searchText = LETTERHEADER_ADDRESS_BLOCK_SEARCH_TEXT) {
  ...
  updateFromDraft(draft, options, searchText = LETTERHEADER_ADDRESS_BLOCK_SEARCH_TEXT) {
  ...
  showVariable(searchText = LETTERHEADER_ADDRESS_BLOCK_SEARCH_TEXT) {
