...
describe('address variable', () => {
  ...
  it('shows, import, and deletes the address variable', () => {
    ...
    cy.get('@section').contains(LETTERHEADER_ADDRESS_BLOCK_SEARCH_TEXT);
  ...
  it('types in the address variable', () => {
    ...
    cy.get('.sectionContainer .lexical-editor-input').type(LETTERHEADER_ADDRESS_BLOCK_SEARCH_TEXT);
      ...
      sections: [
        {
          id: '64feda2f-1a05-46a5-9198-350aabbdac64',
          draftId: '2a23e42f-3009-465c-8348-28afa146c569',
          text: `<p>${LETTERHEADER_ADDRESS_BLOCK_SEARCH_TEXT}</p>`,
          order: 0,
        },
      ],
    };
