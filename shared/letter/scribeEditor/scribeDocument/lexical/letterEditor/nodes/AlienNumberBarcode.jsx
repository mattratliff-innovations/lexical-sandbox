...
import { getApplicantOrPetitionerAnumber } from '../nodeDomSerializers/DraftSerializerUtil';
...
class AlienNumberBarcode extends DecoratorNode {
  ...
  showVariable() {
    if (this.__showBarcode === false && this.__alienNumber === ALIEN_NUMBER_BARCODE_SEARCH_TEXT) {
      return;
    }
