...
export default function useTableCellBtnCreation(tableCellDOMNode, setMainAnchorEl, cellRef, preCellRef, setCurSelection) {
  ...
  const handleButtonAction = useCallback(
    (evt) => {
      ...
      setMainAnchorEl(evt.currentTarget);
    },
    [setMainAnchorEl]
  );
  ...
  }, [tableCellDOMNode, setMainAnchorEl, cellRef, preCellRef]);
}
