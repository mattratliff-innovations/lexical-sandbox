...
jest.mock('../flag/FeatureFlagsProvider', () => ({
  useFeatureFlags: () => ({
    featureFlags: {},
    hasFlag: jest.fn(() => true), // Provide or simulate the expected behavior of hasFlag
  }),
}));
...
describe('manage Snippet within Group', () => {
  ...
  jest.mock('../flag/FeatureFlagsProvider', () => ({
    useFeatureFlags: () => ({
      featureFlags: {},
      hasFlag: jest.fn((flags, flagName) => flags?.find((flag) => flag.id === flagName)?.state === true),
    }),
  }));
