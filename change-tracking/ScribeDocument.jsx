...
import { TrackedSectionEditor } from './LetterChangeTracker';
...
const ScribeDocument = forwardRef(
  (
    ...
    const createEditor = (frontEndId, initialValue, editable, section = {}) => {
      ...
      const isSection = !frontEndId.includes('starts') && !frontEndId.includes('ends');
...
ScribeDocument.propTypes = {
  ...
  letterChangeTracking: PropTypes.shape({
